...
//default servers
char Server1Name[MAX_PATH] = "VanillaGaming";
char Server1Realm[MAX_PATH] = "Logon.vanillagaming.org";
char Server1Website[MAX_PATH] = "http://www.vanillagaming.org";
char Server2Name[MAX_PATH] = "RetroWoW";
char Server2Realm[MAX_PATH] = "logon.retro-wow.com";
char Server2Website[MAX_PATH] = "http://retro-wow.com/";
char Server3Name[MAX_PATH] = "KRONOS";
char Server3Realm[MAX_PATH] = "wow.twinstar.cz";
char Server3Website[MAX_PATH] = "http://www.kronos-wow.com";
char Server4Name[MAX_PATH] = "Elysium Project";
char Server4Realm[MAX_PATH] = "logon.elysium-project.org";
char Server4Website[MAX_PATH] = "http://elysium-project.org/";
